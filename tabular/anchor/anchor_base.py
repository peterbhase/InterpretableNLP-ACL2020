...
class AnchorBaseBeam(object):
    ...
    def get_anchor_from_tuple(t, state):
        ...
        # Hase adds these lines, because precision and coverage are lists
        anchor['max_precision'] = anchor['precision'][-1]
        anchor['last_coverage'] = anchor['coverage'][-1]
        return anchor
    ...
    def anchor_beam(sample_fn, delta=0.05, epsilon=0.1, batch_size=10,
        ...
        while current_size <= max_anchor_size:
            ...
            chosen_tuples = AnchorBaseBeam.lucb(
                sample_fns, initial_stats, epsilon, delta, int(batch_size),
