...
class EvaluatorBase():
    ...
    def predict_evaluation_score(self, tagger, word_sequences, targets_tag_sequences, batch_size):
        ''' note .get_evaluation_score is a method in the evaluator_... classes that build on this base class'''
        outputs_tag_sequences = tagger.predict_tags_from_words(word_sequences, batch_size)
        return self.get_evaluation_score(targets_tag_sequences, outputs_tag_sequences)
