...
class AnchorBaseBeam(object):
    ...
    def anchor_beam(sample_fn, delta=0.05, epsilon=0.1, batch_size=10,
                    ...
                    verbose=False, epsilon_stop=0.05, min_samples_start=1,
        ...
        # empty lists were being returned as explanations unless this was commented
            ...
            for i, t in zip(chosen_tuples, best_of_size[current_size]):
                ...
                if mean >= desired_confidence and lb > desired_confidence - epsilon_stop:
                    ...
                    if coverage > best_coverage:
                        # prohibit the use of a sentence's punctuation token
                        # if (data.shape[1]-1) in state['t_order'][t]:
                        #     continue
